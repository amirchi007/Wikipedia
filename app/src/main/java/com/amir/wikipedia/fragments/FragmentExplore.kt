...
import com.amir.wikipedia.adapters.ExploreAdapter
...
class FragmentExplore : Fragment(), ItemEvent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        LinearLayoutManager(
            ...
            false
        ).also { binding.recyclerExplore.layoutManager = it }
    ...
    override fun onItemClicked(itemPost: ItemPost) {
        // set clickListener for all types of components in cardView exploreFragment
