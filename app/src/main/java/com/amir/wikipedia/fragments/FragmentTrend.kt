...
import com.amir.wikipedia.activity.MainActivity2
import com.amir.wikipedia.adapters.ItemEvent
import com.amir.wikipedia.adapters.TrendAdapter
...
class FragmentTrend : Fragment(),ItemEvent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //  create data and set it to recyclerView
        ...
        // get adapter from ExploreAdapter
        val myAdapter = TrendAdapter(dataTrend,this)

        //   show item vertical
        LinearLayoutManager(context, RecyclerView.VERTICAL,false).also { binding.recyclerTrend .layoutManager = it }
    ...
    override fun onItemClicked(itemPost: ItemPost) {
        // set clickListener for all types of components in cardView trendFragment
